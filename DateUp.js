		    ...
		    jQuery.ajaxSetup({
		        converters: {
		            "text json": function (jsonString) {
		                var dataAsJsonObject = jQuery.parseJSON(jsonString);
		                var dataObjectWithDates = dup(dataAsJsonObject);
		                return dataObjectWithDates;
		            }
		        }
		        /*
		        ,
		        ...
		        if (type === "json") {
		        var dataAsJsonObject = jQuery.parseJSON(data);
		        var dataObjectWithDates = dup(dataAsJsonObject);
		        return dataObjectWithDates;
		        }
		        return data;
